...
Part A Fit a linear regression model to the data with “CLAIM_AMOUNT” as the response and other variables as explanatory variables (consider “Age” as numerical variable and others as categorical variables).
...
B.  Determine 95% confidence intervals for the parameters of the regression model.

C. Plot “QQ plot of the residuals” and comment on applicability of linear regression model.
