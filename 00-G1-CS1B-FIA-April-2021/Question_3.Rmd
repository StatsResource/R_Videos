...
L(pሻ ∝ p\sum yi (1 – pሻn – \sum yi . 
* The posterior density of $p$ is given by: 
f(p|y) ∝ p2 + \sum yi(1 – pሻ11 + n – \sumyi ,
...
(a) Plot the posterior density of $p$ by adding it to the plot in part (iii). 
...
(vi)
```{r}
predict(Model3, data.frame(temp=0,semester="semester",route="8am"),type = "response") 
```
