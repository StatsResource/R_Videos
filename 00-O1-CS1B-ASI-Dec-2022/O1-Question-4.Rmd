...
drawn by the Government, then the ticketholder is entitled to a jackpot.
* The amount of jackpot is INR 2 crore. 
* Kindly note that for white balls, the order is not considered relevant  while matching.
