...
Q. 4) Government of “Actuaria” is operating a popular jackpot lottery called “Power Ball”. The 
...
After drawing 5 white balls and the power ball, a ticket is issued for INR 0.50. A specimen 
ticket is given below –
...
jackpot is INR 2 crore. Kindly note that for white balls, the order is not considered relevant 
while matching.
...
probabilities of matching white balls and power ball under Cases A to I. (4)
...
vectors prob_w_draw and prob_r_draw created in part (i)(c). (2)
...
determined in part (i)(d) and the prize money vector created in part (i)(e). (2)
...
iii) Point out the difference, if any, in the outcomes under part (i) and (ii). (2)
...
the differences in the two. (3)
v) Which distribution is more suitable to model these matching probabilities – hypergeometric or binomial? Substantiate with reasons. (2)
...
[7] 1.425866e-03 1.087223e-02 2.609335e-02 [2]
