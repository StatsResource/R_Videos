...
<tt>head()</tt>, to display the first eight values of A_vec in your answer script.  
...
(iv) Plot, on a single graph, four line graphs of the values of <tt>F_u</tt> against x for 
...
plot( 
 x, 
 F_u(A_greater_than_u = A_exceed_u(A = A_vec,u = 1)), 
 type = "l", 
