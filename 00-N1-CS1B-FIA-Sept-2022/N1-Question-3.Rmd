...
(i) Plot record.time as a function of record.date.  
(ii) Calculate the Pearson’s correlation coefficient between the two data sets.  
...
(iv) Plot the regression line by adding it to the plot from part (i).  
...
output of the fitted model from part (iii).  
(vi) Comment on the relationship between the two variables.  
