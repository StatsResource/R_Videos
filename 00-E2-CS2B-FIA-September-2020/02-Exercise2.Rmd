...
CS2B S2020–3 2Before answering this question, generate the vector, X, in R using the following code:set.seed(1027); X = rexp(n=1000, rate=0.01)The vector X represents the gross claim sizes of 1,000 claims. 
...
(2. Generate an additional vector, Y, which is of the same length as X, such that Yrepresents the amounts to be paid by the insurer for each component of X.  [1] 
