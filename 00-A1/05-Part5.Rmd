...
The data given in the file “\texttt{CablesDataset.csv}” show failure times in years for 20
different cables.
...
An analyst suggests that the 6th row of the original data should be removed. Construct a new data set from the original data \textbf{\textit{CablesDataset.csv}}
...
The residuals plot indicates that data point 6 is an outlier.
...
Fit a generalised linear model (GLM) to the data set constructed in
