...
Thanks, Kevin — here’s a cleaned-up and well-structured version of your solution for **Solution 2**, formatted for clarity and consistency in R Markdown style:
...
- p-value = `0.07838`  
- Conclusion: Cannot reject H₀ that City and Age coefficients are zero
...
- Equation: `Value = 2056.47 - 1045.54 × Device`  
- Adjusted R²: `0.5976`  
...
- Log link ensures μ = exp(linear predictor), keeping μ > 0  
...
- Only Device used in model → same prediction for both
